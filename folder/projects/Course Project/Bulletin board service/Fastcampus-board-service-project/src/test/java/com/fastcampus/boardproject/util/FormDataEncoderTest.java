package com.fastcampus.boardproject.util;
...
@DisplayName("Test Tools - Form Data Encoder")
...
class FormDataEncoderTest {
    ...
    @DisplayName("With object, it will return a string of the form body data type with url encoded.")
    @Test
