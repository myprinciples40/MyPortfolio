...
//Integration Test
//@WebMvcTest
@Disabled("Exclude Spring Data REST integration tests as they are unnecessary")
...
class DataRestTest {
    ...
    @DisplayName("[api] search post list")
    @Test
...
//                .andDo(print());
    ...
    @DisplayName("[api] search single post")
    @Test
    ...
    @DisplayName("[api] search post -> comments list")
    @Test
    ...
    @DisplayName("[api] search comments list")
    @Test
    ...
    @DisplayName("[api] I do not provide any member-related APIs.")
    @Test
